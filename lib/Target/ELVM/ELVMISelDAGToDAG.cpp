//===-- ELVMISelDAGToDAG.cpp - A dag to dag inst selector for ELVM ----------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines a DAG pattern matching instruction selector for ELVM,
// converting from a legalized dag to a ELVM dag.
//
//===----------------------------------------------------------------------===//
...
#define DEBUG_TYPE "elvm-isel"

// Instruction Selector Implementation
namespace {

class ELVMDAGToDAGISel : public SelectionDAGISel {
public:
  explicit ELVMDAGToDAGISel(ELVMTargetMachine &TM) : SelectionDAGISel(TM) {}

  StringRef getPassName() const override {
    return "ELVM DAG->DAG Pattern Instruction Selection";
  }

private:
// Include the pieces autogenerated from the target description.
#include "ELVMGenDAGISel.inc"
...
// ComplexPattern used on ELVM FI instruction
bool ELVMDAGToDAGISel::SelectFIAddr(SDValue Addr, SDValue &Base, SDValue &Offset) {
  SDLoc DL(Addr);
...
void ELVMDAGToDAGISel::Select(SDNode *Node) {
...
FunctionPass *llvm::createELVMISelDag(ELVMTargetMachine &TM) {
  return new ELVMDAGToDAGISel(TM);
}
